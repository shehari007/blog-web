  ...
  const ItemId = params.category
    ...
    useEffect(() => {
        ...
        const getUsers = async () => {
            const res = await axios(`http://localhost/allcat.php?kategori=${ItemId}`);
      ...
      <Banner/>
        ...
        <div className="col-md-8">
          ...
          <article className="blog-post">
            ...
            <p>{data.post}This blog post shows a few different types of content that’s supported and styled with Bootstrap. Basic typography, lists, tables, images, code, and more are all supported as expected.</p>
          ...
          <article className="blog-post">
            ...
            <p className="blog-post-meta">January 1, 2021 by <a href="localhost:3000">Mark</a></p>
          ...
          <article className="blog-post">
            ...
            <p className="blog-post-meta">December 23, 2020 by <a href="localhost:3000">Jacob</a></p>
          ...
          <article className="blog-post">
            ...
            <p className="blog-post-meta">December 14, 2020 by <a href="localhost:3000">Chris</a></p>
